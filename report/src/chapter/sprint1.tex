...
\begin{figure}
\centering
\includegraphics[width=6in]{image/s1serverClassDiagram.png}
\caption{Client Class Diagram}
...
\begin{figure}
\centering
\includegraphics[width=6in]{image/s1ComponentDiagram.png}
...
\begin{figure}
\centering
\includegraphics[width=6in]{image/s1DeploymentDiagram.png}
