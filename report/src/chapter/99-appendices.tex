...
\hline \\ [-1.5ex]
% Execution steps & \pbox{13cm}{1. Open a new client \\ 2. Make a group of books and apply a function that adds 15% of the price. \\ 3. Make another group of books and apply a function that subtracts 15% of the price.} \vspace{3pt} \\
\hline \\ [-1.5ex]
